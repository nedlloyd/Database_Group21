...
//remove column
$sql = "ALTER TABLE product DROP COLUMN endTime;";
...
$sql = "ALTER TABLE product DROP COLUMN endDate;";
if ($con->query($sql) === TRUE) {
    echo "column removed";
} else {
    echo "removing column: " . $con->error;
...
$sql = "ALTER TABLE product DROP COLUMN startTime;";
if ($con->query($sql) === TRUE) {
    echo "column removed";
} else {
    echo "removing column: " . $con->error;
...
$sql = "ALTER TABLE product DROP COLUMN startDate;";
if ($con->query($sql) === TRUE) {
    echo "column removed";
} else {
    echo "removing column: " . $con->error;
...
// add_column
$sql = "ALTER TABLE product ADD COLUMN endDateTime VARCHAR(120);";
