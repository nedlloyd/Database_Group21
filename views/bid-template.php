      ...
      <form class="form-horizontal" method="post">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input name="userID" type="hidden" class="form-control" columns="7" id="userID" placeholder="userID">
            </div>
          </div>
<p>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input name="productID" type="hidden" class="form-control" columns="7" id="productID" placeholder="productID">
            </div>
          </div>
<p>
...
$stmt->bind_param("sss", $_POST['amount'], $productID, $userID);
$stmt->execute();
